    ...
    $('[data-tab]').click(function(e) {
        ...
        if(!isAnimating) {
            ...
            if($('.hidden_content',parent).hasClass('active')){
				...
				$('.js_swiper_teasers').each(function(){
					var index = $(this).index();
					$(this).addClass('swiper_'+index);
					
					var swiper = new Swiper('.js_swiper_teasers.swiper_'+index+'  .swiper-container', {
						slidesPerView: '3',
						spaceBetween: 0,
						loop: false,
						nextButton: '.js_swiper_teasers.swiper_'+index+' .js_swiper_next',
						prevButton: '.js_swiper_teasers.swiper_'+index+' .js_swiper_prev',
...
/*main page autoplay slider*/
var sliderInterval;
function RunAutoSlide(){
	sliderInterval = setInterval(function() {
	if($('.main_slider_controls .swiper-wrapper .swiper-slide.active').index()==$('.main_slider_controls .swiper-wrapper .swiper-slide').length-1)
	{	
		$('.main_slider_controls .swiper-wrapper .swiper-slide:eq(0)').click();
		
	}
	else {
		$('.main_slider_controls .swiper-wrapper .swiper-slide.active').next().click();
		
	}
}, 5000);
}
/*end main page autoplay slider*/
...
$(document).ready(function(){
	...
	$('.main_slider_controls .swiper-wrapper .swiper-slide').click(function(){
...
$('[data-popup]').on('click', function(e){
	...
	$('.popup_gallery_slider .flexslider .slides.small_slides > li:eq('+startSlide+')').click();
	$(window).resize();
...
$('.main_slider_slides .swiper-slide-active').next().click();
...
if(navigator.userAgent.match(/Android/i) ||
		...
		navigator.userAgent.match(/Blackberry/i) )
    {
	$('.sub_menu_1').addClass('hide_submenu');
}

$('.news_block_type_4 .block').each(function(){
...
$('.main_menu li').each(function(){
		if($(this).find('.sub_menu_1').length==0){
			$(this).find('a').addClass('no_triangle');
			$(this).find('span').addClass('no_triangle');
		}									
})
